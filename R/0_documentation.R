...
rd_burden_level_family <- "A character string specifying the family for modeling burden levels. 
        Choose between 'lnorm', 'weibull', 'exp', or 'beta'. Use 'beta' for proportional/binomial data on the [0, 1] scale. If `NULL`, defaults to 'beta' for proportional data and 'lnorm' otherwise. Proportional data must use 'beta'; non-proportional data cannot use 'beta'."
