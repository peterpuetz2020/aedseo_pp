...
In this example it is done with the four available previous seasons.
...
In other words, a season onset is declared when the average case count over five weeks surpasses 25 and is
...
By inspecting the output from the above code, the disease-specific threshold is established at `25` cases.
